      ...
      <div style={{ backgroundColor: '#F5F5F5', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '100px' }}>
        ...
        <div style={{ textAlign: 'left', fontFamily: 'Copperplate', margin: '2%' }}>
          <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <AccordionDetails>
              <Typography>
                We believe that pet rehoming and adoption should be a kind, safe and reliable process for every being involved. <br />
          ...
          <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
            <AccordionSummary
              ...
              id="panel2bh-header"
            >
              <Typography sx={{ flexShrink: 0 }}>Why should I look for a pet on PetRehomer before i visit a rescue center</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
          ...
          <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
            <AccordionSummary
              ...
              id="panel3bh-header">
              <Typography sx={{ flexShrink: 0 }}>
                Rescue centres often don't let people adopt a pet because they have young children or no garden. Does PetRehomer follow the same rules?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
          ...
          <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
            <AccordionSummary
              ...
              id="panel5bh-header">
              <Typography sx={{ flexShrink: 0 }}>
                Does PetRehomer verify the pet's health record before listing?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
          ...
          <Accordion expanded={expanded === 'panel8'} onChange={handleChange('panel8')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                it is better not to go ahead with the adoption and contact the PetRehomer team to let us know. If you don't end up adopting the pet we will refund your adoption fee.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === 'panel9'} onChange={handleChange('panel9')}>
            <AccordionSummary
              ...
              id="panel9bh-header">
              <Typography sx={{ flexShrink: 0 }}>
                How does PetRehomer deal with scammers or pet sellers?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
