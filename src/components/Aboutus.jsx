    ...
    return (
        <>
            ...
            <div className="text-center mt-3">
               <h2 style={{fontFamily: 'Copperplate'}}><b>AboutUs/Volunteer</b></h2>
            </div>
            <Container>
                <Row>
                    <Col xs={8} md={4}>
                ...
                <br /> <br />
                <div className="container" style={{ backgroundColor: '#DFE3E8', height: '300vh', width: '100vw' }}>
                    <br /> <br />
                    ...
                    <div className="row justify-content-center mt-5">
                        <div className="col-md-5" >
                            <div className="card">
                                <br />
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOtU4Qi62we1qdMHXFeyNzNDLyGilnJE9CsjrjW02K4g&s" className="rounded-top img-fluid mx-auto d-block mt-2" alt="kind-cards-img" style={{ height: '50px', width: 'auto' }} />
                                <div className="card-body" style={{ fontFamily: 'Copperplate' }}>
                                    <p className="card-text text-center mb-1"><h4>Rehoming Co-Ordinators</h4></p>
                        ...
                        <div className="col-md-5">
                            <div className="card">
                                <br />
                                <img src="https://thumbs.dreamstime.com/b/black-round-veterinary-care-icon-cross-pet-45004984.jpg" className="rounded-top img-fluid mx-auto d-block mt-2" alt="kind-cards-img" style={{ height: '50px', width: 'auto' }} />
                                <div className="card-body" style={{ fontFamily: 'Copperplate' }}>
                    ...
                    <div className="row justify-content-center mt-5">
                        <div className="col-md-5" >
                            <div className="card" >
                                <br />
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxtgHXQPrtWyFmN4rW6_aACB6seI1DrGIAPwOHR1CmMvoFPW17qZ5HeIirzbQYzIpymd8&usqp=CAU" className="rounded-top img-fluid mx-auto d-block mt-2" alt="kind-cards-img" style={{ height: '50px', width: 'auto' }} />
                                <div className="card-body" style={{ fontFamily: 'Copperplate' }}>
                        ...
                        <div className="col-md-5">
                            <div className="card" style={{ height: '350px', width: 'auto' }}>
                                <br />
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9gvy_a470qMElJlBINXAh2BW4exI_c0Njylqn7NzLTQ88mobmAUHI4TLZEwLpgX8BeFY&usqp=CAU" className="rounded-top img-fluid mx-auto d-block mt-2" alt="kind-cards-img" style={{ height: '50px', width: 'auto' }} />
                                <div className="card-body" style={{ fontFamily: 'Copperplate' }}>
